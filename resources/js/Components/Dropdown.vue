			...
			<div class="space-y-1.5">
				...
				<div v-show="mainMenus[1].status"
					...
					<div class="flex flex-col space-y-1.5">
						...
						<form-error v-if="formData.errors.date" :errors="formData.errors">{{ formData.errors.date[0] }}</form-error>
					</div>
					<div>
						...
						<form-error v-if="formData.errors.kostentraeger" :errors="formData.errors">@{{ formData.errors.kostentraeger[0] }}</form-error>
					</div>
					<div class="flex flex-col md:col-span-2 lg:col-span-1 space-y-1.5">
						...
						<textarea v-model="formData.bemerkungen" rows="7"
							class="border-0 rounded-2xl shadow-lg hover:border-yellow-200 focus:ring-2 focus:ring-yellow-200" />
						<form-error v-if="formData.errors.bemerkungen" :errors="formData.errors">@{{ formData.errors.bemerkungen[0] }}</form-error>
					</div>
				</div>
